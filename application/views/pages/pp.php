    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <p>If you choose to buy on the Site, we collect information about your buying behavior.</p>
                ...
                <p>If you register for the Site on another web site or use a web site providing a service for Prk Fashions or a web site that helps facilitates your activity on the Site, that web site may provide personal information about you and your transactions back to us.</p>
                <hr/>
                ...
                <p>Your personal information is an important part of our business and we are not in the business of selling it to others. Prkfashions.com shares your personal information only to categories of persons that are either subject to this Privacy Policy or follow practices at least as protective as those described in this Privacy Policy as more particularly described below:</p>
                <hr/>
                <h5><strong>Advertisements</strong></h5>
                <p>A. Where a user enters information on any form of an advertiser, the information is simultaneously collected by Prkfashions.com and the advertiser. The information is used by Prkfashions.com in accordance with the terms of this privacy policy and is used by the advertiser as per the advertiser&rsquo;s prevalent privacy policies. Since we do not control the privacy practices of these advertisers, you should evaluate their practices before deciding to provide the said information.</p>
                <p>B. Prkfashions.com may also use personally identifiable information in an aggregated form and disclose to advertisers and other third parties for other marketing and promotional purposes.</p>
                <hr/>
                ...
                <p>In order to facilitate interaction among all Prkfashions.com members (buyers, services providers such as payment gateway and 3PLs, our Site allows you to access other users' contact information. Further, as a buyer you will be sent via email the Prkfashions.com registered user ID email address and other information, and as a winning buyer you will be sent via email the Prkfashions.com registered user ID email address and other information of the buyer. By entering into our User Agreement, you agree that, with respect to other user's personally identifiable information that you obtain through the Site or through a Prkfashions.com-related communication or Prk Fashions-facilitated transaction, Prkfashions.com hereby grants to you a license to use such information only for:</p>
                <p>(a). Prk Fashions.-related communications that are not unsolicited commercial messages, (b). using co-branded services offered through Prkfashions.com (e.g. insurance, shipping and fraud complaints), and (c). any other purpose that such user expressly opts into after adequate disclosure of the purpose(s).</p>
                ...
                <p>Prkfashions.com and our users do not tolerate spam. Therefore, without limiting the foregoing, you are not licensed to add a Prkfashions.com user-even a user who has purchased an item from you-to your mail list (email or physical mail) without their express consent after adequate disclosure.</p>
                <hr/>
                <h4><strong>Access or change your personally identifiable information</strong></h4>
                <p>To protect your privacy and security, we will verify your identity before granting access or making changes to your personally identifying information. If you have registered your profile on Prkfashions.com, your registered user ID and Password are required in order to access your profile information.</p>
                ...
                <p>By using the Site and/ or by providing your information, you acknowledge our use of your personal information in the manner as set out in this Privacy Policy. Any changes to our privacy policy will be communicated through our Web site at least 10 days in advance of implementation. Name and address of the entity collecting and retaining your information shall be the contracting entity stated in the Prkfashions.com User Agreement.</p>
