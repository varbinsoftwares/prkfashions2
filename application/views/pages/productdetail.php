                    ...
                    <div class="my-md-3">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-3 flex-nowrap flex-xl-wrap overflow-auto overflow-xl-visble">
                                ...
                                <li class="breadcrumb-item flex-shrink-0 flex-xl-shrink-1"><a href="../shop/shop.html">Mens wear</a></li>
                                <li class="breadcrumb-item flex-shrink-0 flex-xl-shrink-1"><a href="../shop/shop.html">Shirts</a></li>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-4 col-xl-5 mb-4 mb-md-0">
                            <div id="sliderSyncingNav" class="js-slick-carousel u-slick mb-2"
                                ...
                                <div class="js-slide">
                                    <img class="img-fluid" src="<?php echo base_url();?>assets/theme2/images/JJT_803/1.JPG" alt="Image Description">
                                </div>
                                <div class="js-slide">
                                    <img class="img-fluid" src="<?php echo base_url();?>assets/theme2/images/JJT_803/2.JPG" alt="Image Description">
                                </div>
                                <div class="js-slide">
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-4 mb-md-6 mb-lg-0">
                            <div class="mb-2">
                                <a href="#" class="font-size-12 text-gray-5 mb-2 d-inline-block">Shirts</a>
                                <h2 class="font-size-25 text-lh-1dot2">Blue strip shirt</h2>
                                <div class="mb-2">
