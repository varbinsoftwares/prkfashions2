                    ...
                    <td >
                        <center><img src="<?php echo site_mail_logo; ?> " style="margin: 10px;
                            ...
                            <h4 style="color: white;    margin-top: 0px;"> Your Appointment <br>
                                    <small>
                                        Appointment Date & Time: <?php echo date_format(date_create($appointment['select_date']), "l, d F Y"); ?> (<?php echo $appointment['select_time']; ?>)
                                    </small>
                            </h4>
                        </center>
                    </td>
            ...
            <table class="carttable"  border-color= "#9E9E9E" align="center" border="1" cellpadding="0" cellspacing="0" width="700" style="background: #fff;padding:20px">
                ...
                <tr>
                    <td colspan="6" style="font-size: 12px;">
                        ...
                        <p>We have booked your appointment to see our Chief Tailor, on <b><?php echo date_format($opdater = date_create($appointment['select_date']), "l, d F Y"); ?>, <?php echo $appointment['select_time']; ?></b> at 
                                <?php
